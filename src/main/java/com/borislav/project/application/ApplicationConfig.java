package com.borislav.project.application;
...
public class ApplicationConfig extends Application{
    ...
    public Set<Class<?>> getClasses() {
        ...
        resources.add(com.borislav.project.provider.MyJsonProvider.class);
        resources.add(com.borislav.project.resource.MasterResource.class);
